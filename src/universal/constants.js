...
export const SUPPRESSED_BRANDS = ['HomeAway'];
...
export const EPS_CHANNEL_SITE_URL = {
    'E4P API': ['hawaiian.poweredbygps.com',
        'hawaiian.poweredbygps.com.au',
        'hawaiian.poweredbygps.co.nz',
        'hawaiian.poweredbygps.co.jp',
        'hawaiian.poweredbygps.co.kr',
        'amextravel.com',
        'travel.americanexpress.com'],
    'E4P Template': ['hotels.airnewzealand.co.nz',
        'hotels.airnewzealand.com.au',
        'hotels.airnewzealand.com',
        'hotels.airnewzealand.ca',
        'hotels.airnewzealand.com.hk',
        'hotels.airnewzealand.co.jp',
        'hotels.airnewzealand.com.sg',
        'expedia-be.eurostar.com',
        'expedia-fr.eurostar.com',
        ...
        'reservations.edwardian.com',
        'iberostarvacations.poweredbygps.com',
        'uk.holidays.vueling.com',
        'es.holidays.vueling.com',
        'it.holidays.vueling.com',
        ...
        'ww5.neckermann-reisen.at',
        'ww5.neckermann-reisen.ch',
        'www.expedia-aarp.com',
        'www.expediafortd.com',
        'travel.rbcrewards.com',
        'travel.chase.com',
        'marriottholidays.poweredbygps.co.uk',
        'marriottholidays.poweredbygps.de',
        'vacationsbymarriott.poweredbygps.com'],
    'RAPID': [],
    'TAAP': ['taap.expedia.US',
        'taap.expedia.UK',
        'taap.expedia.CA',
        'taap.expedia.DE',
        'taap.expedia.IT',
