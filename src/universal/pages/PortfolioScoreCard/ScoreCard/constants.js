...
export const SCORECARD_COLUMNS = ['Organization', 'P1', 'P2', 'TTD<=15m', 'TTK<=30m', 'TTF<=15m', 'TTR<=60m', 'Corrective Actions'];
...
export const SCORECARD_COLUMNS_INFO = {
    ...
    'TTR<=60m': <div>{'Time to Restore with >=75% highlighted'}</div>
};
...
export const TICKET_DETAILS_INFO = {
    ...
    'Time To Restore': <div>{'Time to Restore in minutes'}<br />{'with <=60m highlighted'}</div>
};
