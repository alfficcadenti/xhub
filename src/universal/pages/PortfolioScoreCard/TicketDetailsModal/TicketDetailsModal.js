...
const TicketDetailsModal = ({isOpen, start, end, onClose, onBack, currentL, currentClickedOrg, currentP}) => {
    ...
    useEffect(() => {
        ...
        fetch(`/v1/org-metrics/business-owner-type/${currentP}/${currentL}/${currentClickedOrg}?from_date=${start}&to_date=${end}`)
            .then(checkResponse)
            .then((response) => {
