Feature: Verify user is able to navigate around Impulse Dashboard
  ...
  Scenario Outline: User is able to use the nav bar to navigate
    ...
    | Expedia                  | availabilityTrendsLink2 | brandFilter | brandOptionFilter1 | lobFilter | lobOptionFilter | posFilter | posOptionFilter | incidentsFilter | incidentsOptionFilter | incidentsCheckbox | anomaliesCheckbox | setTimeFilter | setTimeFilterOption | anomaliesFilter | anomaliesOptionFilter | submitFilters | resetFilters | resetGraph |
    | Hotelscom                | availabilityTrendsLink3 | brandFilter | brandOptionFilter1 | lobFilter | lobOptionFilter | posFilter | posOptionFilter | incidentsFilter | incidentsOptionFilter | incidentsCheckbox | anomaliesCheckbox | setTimeFilter | setTimeFilterOption | anomaliesFilter | anomaliesOptionFilter | submitFilters | resetFilters | resetGraph |
    | ExpediaPartnerSolutions  | availabilityTrendsLink2 | brandFilter | brandOptionFilter1 | lobFilter | lobOptionFilter | posFilter | posOptionFilter | incidentsFilter | incidentsOptionFilter | incidentsCheckbox | anomaliesCheckbox | setTimeFilter | setTimeFilterOption | anomaliesFilter | anomaliesOptionFilter | submitFilters | resetFilters | resetGraph |